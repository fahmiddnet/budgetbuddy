  ...
  <div class="authentication-inner row m-0">
    ...
    <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center p-5">
      <div class="w-100 d-flex justify-content-center">
        <img src="img/boy-with-rocket-light.png" class="img-fluid" alt="Login image" width="700" data-app-dark-img="boy-with-rocket-dark.png" data-app-light-img="boy-with-rocket-light.png">
      </div>
    </div>
    <!-- /Left Text -->
    ...
    <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
      <g id="Icon" transform="translate(27.000000, 15.000000)">
        ...
        <form class="mb-3" action="Auth/login_auth.php" method="POST">
          ...
          <input type="submit" value="Sign in" class="btn btn-primary d-grid w-100">
          </input>
        </form>
...
<script src="js/auto-focus.js"></script>
